...
namespace Shopping.Database.Migrations
{
    ...
    [Migration("20231220145309_AddUpdateDateToCommodityModelAndAddAllFeatureViews")]
    partial class AddUpdateDateToCommodityModelAndAddAllFeatureViews
    {
            ...
            modelBuilder.Entity("Shopping.Database.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c5e461ea-c859-484f-a15d-efb4a1ebda4d"),
                            RoleEnName = "Admin",
                            RoleFaName = "مدیر"
                        },
                        new
                        {
                            Id = new Guid("06ff3e2a-b8c1-4ab8-abfd-a46485f96189"),
                            RoleEnName = "User",
                            RoleFaName = "کاربر"
                        });
                });
            ...
            modelBuilder.Entity("Shopping.Database.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("26b65f1f-e396-44fc-b9de-1bc00a14e8a2"),
                            FName = "میلاد",
                            Gender = "مرد",
                            LName = "حیدرپور",
                            ...
                            RegisterDate = "1402/09/29 18:23:08",
                            RoleId = new Guid("c5e461ea-c859-484f-a15d-efb4a1ebda4d")
                        });
                });
