...
namespace Shopping.Database.Migrations
{
    ...
    [Migration("20231128151904_AddGroupIdToCommodityModel")]
    partial class AddGroupIdToCommodityModel
    {
            ...
            modelBuilder.Entity("Shopping.Database.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("17a74ae2-887d-4b54-ae47-a759cb3b31a6"),
                            RoleEnName = "Admin",
                            RoleFaName = "مدیر"
                        },
                        new
                        {
                            Id = new Guid("3fc8bc3c-146c-4b1c-a7b5-f490ef7db97c"),
                            RoleEnName = "User",
                            RoleFaName = "کاربر"
                        });
                });
            ...
            modelBuilder.Entity("Shopping.Database.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bc02544c-7b35-4256-8c75-fbccf20118ac"),
                            FName = "میلاد",
                            Gender = "مرد",
                            LName = "حیدرپور",
                            ...
                            RegisterDate = "1402/09/07 18:49:04",
                            RoleId = new Guid("17a74ae2-887d-4b54-ae47-a759cb3b31a6")
                        });
                });
