...
namespace Shopping.Database.Migrations
{
    ...
    [Migration("20231118082907_AddBrandGroupCommodityModel")]
    partial class AddBrandGroupCommodityModel
    {
            ...
            modelBuilder.Entity("Shopping.Database.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6e3f2c83-4030-4b26-b6a1-6cf2463d7423"),
                            RoleEnName = "Admin",
                            RoleFaName = "مدیر"
                        },
                        new
                        {
                            Id = new Guid("a242b082-f6f8-4689-8eb8-a9c356a84b8b"),
                            RoleEnName = "User",
                            RoleFaName = "کاربر"
                        });
                });
            ...
            modelBuilder.Entity("Shopping.Database.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6e308a07-0937-4d59-bfad-4ec069975b1c"),
                            FName = "میلاد",
                            Gender = "مرد",
                            LName = "حیدرپور",
                            ...
                            RegisterDate = "1402/08/27 11:59:06",
                            RoleId = new Guid("6e3f2c83-4030-4b26-b6a1-6cf2463d7423")
                        });
                });
