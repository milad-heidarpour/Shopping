...
namespace Shopping.Database.Migrations
{
    ...
    [Migration("20231120171001_AddCommodityAlbumModel")]
    partial class AddCommodityAlbumModel
    {
            ...
            modelBuilder.Entity("Shopping.Database.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("146be7d2-5e69-4f61-b46e-ef31cf46d98c"),
                            RoleEnName = "Admin",
                            RoleFaName = "مدیر"
                        },
                        new
                        {
                            Id = new Guid("f5925ee5-2823-4584-9d92-ee316cb2e3e0"),
                            RoleEnName = "User",
                            RoleFaName = "کاربر"
                        });
                });
            ...
            modelBuilder.Entity("Shopping.Database.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ac1c14f7-0ede-4222-a60e-a3e20099eb93"),
                            FName = "میلاد",
                            Gender = "مرد",
                            LName = "حیدرپور",
                            ...
                            RegisterDate = "1402/08/29 20:40:00",
                            RoleId = new Guid("146be7d2-5e69-4f61-b46e-ef31cf46d98c")
                        });
                });
