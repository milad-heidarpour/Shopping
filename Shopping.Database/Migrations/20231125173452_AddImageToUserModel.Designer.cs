...
namespace Shopping.Database.Migrations
{
    ...
    [Migration("20231125173452_AddImageToUserModel")]
    partial class AddImageToUserModel
    {
            ...
            modelBuilder.Entity("Shopping.Database.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("180d6dc9-1575-4a7e-9416-c4245cd5d63d"),
                            RoleEnName = "Admin",
                            RoleFaName = "مدیر"
                        },
                        new
                        {
                            Id = new Guid("abc8ed9c-fd30-4018-be36-b5f6ba46727f"),
                            RoleEnName = "User",
                            RoleFaName = "کاربر"
                        });
                });
            ...
            modelBuilder.Entity("Shopping.Database.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("97a26a61-dee4-4955-82cc-c871f8beb586"),
                            FName = "میلاد",
                            Gender = "مرد",
                            LName = "حیدرپور",
                            Password = "C4-65-39-0D-14-88-0E-D0-87-DC-E9-8C-CC-E7-D8-93",
                            PhoneNumb = "09030826556",
                            ProfileImg = "wwwroot/images/usersprofile/Admin.jpg",
                            RePassword = "C4-65-39-0D-14-88-0E-D0-87-DC-E9-8C-CC-E7-D8-93",
                            RegisterDate = "1402/09/04 21:04:51",
                            RoleId = new Guid("180d6dc9-1575-4a7e-9416-c4245cd5d63d")
                        });
                });
