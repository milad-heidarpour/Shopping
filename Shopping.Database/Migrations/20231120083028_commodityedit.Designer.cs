...
namespace Shopping.Database.Migrations
{
    ...
    [Migration("20231120083028_commodityedit")]
    partial class commodityedit
    {
            ...
            modelBuilder.Entity("Shopping.Database.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3032770f-c509-4db6-b53b-666b939e1cf9"),
                            RoleEnName = "Admin",
                            RoleFaName = "مدیر"
                        },
                        new
                        {
                            Id = new Guid("35d130f2-7cd7-406a-8801-ba1477aa8dae"),
                            RoleEnName = "User",
                            RoleFaName = "کاربر"
                        });
                });
            ...
            modelBuilder.Entity("Shopping.Database.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("db604566-0037-4ceb-be8e-e0df63754dd4"),
                            FName = "میلاد",
                            Gender = "مرد",
                            LName = "حیدرپور",
                            ...
                            RegisterDate = "1402/08/29 12:00:28",
                            RoleId = new Guid("3032770f-c509-4db6-b53b-666b939e1cf9")
                        });
                });
